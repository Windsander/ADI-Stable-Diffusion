...
macro(define_colors)
    if(WIN32)
        # Check if we are in a Bash-like environment on Windows
        if("$ENV{TERM}" STREQUAL "xterm" OR "$ENV{TERM}" STREQUAL "xterm-256color")
            string(ASCII 27 Esc)
            ...
            # Fallback to no color if not in a Bash-like environment
            set(ColourReset "")
            set(ColourBold "")
            set(Red "")
            set(Green "")
