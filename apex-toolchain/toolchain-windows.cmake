...
function(find_and_set_compiler)
    foreach(COMPILER ${ARGN})
        ...
        if(CC_COMPILER)
            ...
            elseif(${COMPILER} MATCHES "cl")
                ...
                set(CMAKE_C_FLAGS "/arch:${TARGET_ARCH}" CACHE STRING "" FORCE)
                set(CMAKE_CXX_FLAGS "/arch:${TARGET_ARCH}" CACHE STRING "" FORCE)
            endif()
    ...
    endforeach()
    message(STATUS "No suitable compiler found from the list: ${ARGN}")
endfunction()
