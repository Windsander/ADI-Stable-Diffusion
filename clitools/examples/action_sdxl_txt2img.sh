...
././cmake-build-release-gcc-metal/bin/Release/sd\
 ...
 --seed 15.0\
 --dim 768\
 --clip ././sd/sd-base-model/txt_encoder/model.onnx\
 --unet ././sd/sd-base-model/unet/model.onnx\
 --vae-encoder ././sd/sd-base-model/vae_encoder/model.onnx\
 --vae-decoder ././sd/sd-base-model/vae_decoder/model.onnx\
